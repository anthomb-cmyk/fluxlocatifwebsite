    ...
    <footer className="border-t border-slate-800 bg-slate-900 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            <h4 className="mb-4 text-sm font-body font-medium uppercase tracking-widest text-slate-100">Navigation</h4>
          ...
          <div>
            <h4 className="mb-4 text-sm font-body font-medium uppercase tracking-widest text-slate-100">Contact</h4>
            <ul className="space-y-2 text-sm font-body font-normal text-slate-400">
